...
import com.postsapi.posts.domain.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO cmm1 = new CommentDTO("Boa viagem!!!", sdf.parse("21/03/2018"), new AuthorDTO(alex));
        CommentDTO cmm2 = new CommentDTO("Aproveitaaa bjs!!!", sdf.parse("22/03/2018"), new AuthorDTO(bob));
        CommentDTO cmm3 = new CommentDTO("Baum dia", sdf.parse("25/05/2018"), new AuthorDTO(alex));
